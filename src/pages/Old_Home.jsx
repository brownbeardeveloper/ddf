    ...
    <>
      ...
      <div className="homepage-welcome">
            <div className="homepage-welcome-text">
                <p>Välkommen till vår gemensamma hemsida för flera organisationer som stödjer döva och hörselskadade i Örebro, däribland Örebro Dövas Ungdomsklubb, Dövas Förening Örebro, Örebro Dövas Pensionärsförening och Idrottsföreningen Nerike.</p>
                </div>
